...
<div class="context">
    ...
    <h2>Methods</h2>
    <ul style="list-style: disc;">
      <li><pre><a href="#felan"><span class="bluecolor">__construct</span></a><span class="purplecolor">()</span>: <span class="yellowcolor">mixed</span></pre>Initializes this event with the given subject.</li>
