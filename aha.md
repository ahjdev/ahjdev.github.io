...
<div class="context">
    ...
    <ul>
      ...
      <li><pre><li><span class="bluecolor">createInstance</span><span class="purplecolor">()</span>: <span class="yellowcolor">self</span></li></pre>Creates a new instance of a derived object and return that.</li>
