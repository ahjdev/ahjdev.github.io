...
<div class="context">
    ...
    <h2>Methods</h2>
    <ul>
      <li><span class="bluecolor">__construct</span><span class="purplecolor">()</div>: <span class="yellowcolor">mixed</span><br>Initializes this event with the given subject.</li>
